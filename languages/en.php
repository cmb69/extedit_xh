...
$plugin_tx['extedit']['mode_edit']="Edit";
$plugin_tx['extedit']['mode_view']="View";
...
$plugin_tx['extedit']['imagepicker_err_1']="The uploaded file exceeds the upload_max_filesize directive in php.ini!";
$plugin_tx['extedit']['imagepicker_err_2']="The uploaded file exceeds the MAX_FILE_SIZE directive that was specified in the HTML form!";
$plugin_tx['extedit']['imagepicker_err_3']="The uploaded file was only partially uploaded!";
$plugin_tx['extedit']['imagepicker_err_4']="No file was uploaded!";
$plugin_tx['extedit']['imagepicker_err_6']="Missing a temporary folder!";
$plugin_tx['extedit']['imagepicker_err_7']="Failed to write file to disk!";
$plugin_tx['extedit']['imagepicker_err_8']="A PHP extension stopped the file upload!";
$plugin_tx['extedit']['imagepicker_err_nofile']="No file was selected for upload!";
$plugin_tx['extedit']['imagepicker_err_mimetype']="The file is no image.";
$plugin_tx['extedit']['imagepicker_err_save']="The uploaded file could not be saved!";

$plugin_tx['extedit']['synopsis']="Synopsis";
$plugin_tx['extedit']['synopsis_username']="%%USERNAME%%";
$plugin_tx['extedit']['synopsis_username_desc']="The name of the Register_XH or Memberpages_XH user, who may edit the content.";
